...
public class NewEventServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        newEvent.setStartDateAll(req.getParameter("startDate").concat("T").concat(req.getParameter("startTime")));
        newEvent.setEndDateAll(req.getParameter("endDate").concat("T").concat(req.getParameter("endTime")));
